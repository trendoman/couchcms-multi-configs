<?php
    ...
    //define( 'K_ADMIN_PAGE', '../admin/index.php' );
    ...
    define( 'K_DB_NAME', 'live_example_com' );
    // 5.
    // Database username
    ...
    define( 'K_COMMENTS_INTERVAL', 0 * 60 );
    ...
    // 100.
    // Set the following to '1' and enjoy time and query counters
